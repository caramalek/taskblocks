...
public class ColorLabel {
	...
	public static ColorLabel[] COLOR_LABELS = new ColorLabel[] {
		...
		new ColorLabel("Lilac", new Color(208,153,251), 9),
		new ColorLabel("Lime", new Color(140,214,0), 10),
		new ColorLabel("Taupe", new Color(255,228,207), 11),
		new ColorLabel("Rose", new Color(233,117,131), 12),
		new ColorLabel("Purple", new Color(149,70,222), 13),
		new ColorLabel("Pink", new Color(255,203,212), 14),
		new ColorLabel("Gray", new Color(104,104,104), 15),        
		...
		new ColorLabel("Cerulean", new Color(13,138,255), 25),
		...
		new ColorLabel("Charcoal", new Color(72,72,72), 30),
